...
import { registerSchemaOld } from "../schemas/registerSchemaOld";
...
// This form is to check CSS in case the current register form is different from this old one
const RegisterFormOld = ({
  initialValues = {
    first_name: "",
    last_name: "",
    company: "",
  ...
  const form = useForm({
    resolver: yupResolver(registerSchemaOld),
...
export default RegisterFormOld;
