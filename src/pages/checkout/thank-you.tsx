    ...
    <div className="min-h-screen bg-background relative isolate">
      ...
      <div className="px-6 py-8 space-y-6 relative z-20">
        ...
        >
          ...
          <div className="bg-[rgba(245,245,245,0.5)] rounded-lg border border-[#E5E5E5] divide-y">
            <div className="p-4">
            ...
            <div className="p-4">
              <div className="flex justify-between items-center">
                <span className="text-sm text-muted-foreground">{t("Amount Paid")}</span>
          ...
          <div className="space-y-3">
            <div className="bg-[rgba(245,245,245,0.5)] rounded-lg border border-[#E5E5E5] p-4">
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1">
                  <h3 className="text-sm font-medium mb-1">{t("Order Processing")}</h3>
            ...
            <div className="bg-[rgba(245,245,245,0.5)] rounded-lg border border-[#E5E5E5] p-4">
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1">
                  <h3 className="text-sm font-medium mb-1">{t("Estimated Delivery")}</h3>
                  <p className="text-sm text-muted-foreground">
