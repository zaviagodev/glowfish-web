...
import { Upload, X, Download, Clock, ArrowRight, CheckCircle2, Sparkles } from "lucide-react";
...
const mockQRCode = "https://upload.wikimedia.org/wikipedia/commons/d/d0/QR_code_for_mobile_English_Wikipedia.svg";
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="pt-14 pb-32">
        ...
        >
          <motion.div 
            className={cn(
              "w-64 h-64 bg-white rounded-2xl shadow-lg p-4 mb-4",
              shimmer
            )}
        ...
        <div className="px-4">
          ...
          >
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <h3 className="text-base font-medium">{t("Payment Confirmation")}</h3>
                  ...
                  >
                    <div className="relative z-10 flex flex-col items-center">
                      ...
                      <p className="text-base font-medium mb-1">
                        {isUploading ? t("Uploading...") : t("Upload Payment Slip")}
                      </p>
                      <p className="text-sm text-muted-foreground">
      ...
      <AnimatePresence>
        {showCelebration && (
          ...
          >
            ...
            >
              <motion.div 
                className="bg-white rounded-full p-8 mb-4 shadow-xl"
                initial={{ y: 20 }}
                animate={{ y: 0 }}
                transition={{ delay: 0.2 }}
              >
