        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="flex items-center gap-3">
              ...
              <FormItem>
                <Popover>
                  <PopoverTrigger asChild>
                    ...
                    >
                      {form.getValues("event_date") ? format(form.getValues("event_date") ?? "", "PP") : <span>{t("Pick a date")}</span>}
                    </Button>
                  </PopoverTrigger>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormControl>
                  <Select onValueChange={(val: any) => form.setValue("event_time", val)} {...field}>
          ...
          <footer className="btn-footer">
            <Button className="main-btn !bg-[#F4DC53] text-black" type="submit">{t("Confirm booking")}</Button>
          </footer>
        </form>
      </Form>
    )
