...
import { type  GetManyResponse, useMany, useNavigation, useGetIdentity, useTranslate } from "@refinedev/core";
...
export const HomeList = () => {
  ...
  return (
    <>
      ...
      >
        <h1>{"List"}</h1>
        <button onClick={() => create("home")}>{"Create"}</button>
      </div>
