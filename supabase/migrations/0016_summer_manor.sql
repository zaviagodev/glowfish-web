/*
# Fix transaction handling in place_order function

1. Changes
  - Remove explicit BEGIN/COMMIT/ROLLBACK statements
  - Let Supabase handle transaction boundaries
...
-- Recreate with fixed transaction handling
