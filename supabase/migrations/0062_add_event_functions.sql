 /*
  # Add Event Management Functions
  
  1. Functions
    - create_event: Creates both product and event in a single transaction
    - update_event: Updates both product and event in a single transaction
*/
